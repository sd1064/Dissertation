...
spherePositionOne = extrinsicSphereCalibration(cameraParams.IntrinsicMatrix,sphereOne,sphereRadius);

sphereTwo = [centres(2,1) centres(2,2) radii(2,1)];
spherePositionTwo = extrinsicSphereCalibration(cameraParams.IntrinsicMatrix,sphereTwo,sphereRadius);
